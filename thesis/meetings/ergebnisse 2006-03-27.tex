...
% ***************************************************************************************************
\begin{itemize}
  \item{Die UML-Darstellung soll in eine druckbare Darstellungsweise überführt werden.}
  \item{Alle übernommenen Ressourcen sollen in eine vereinheitlichte, unserem Zweck am besten dienliche Form gebracht werden.}
  \item{Es soll die Funktionalität zu Erstellung des TGraphen implementiert werden (vorläufige Version).}
  \item{Es soll ein feingranularer TGraph erzeugt werden.}
  \item{Das nächste Treffen findet am 27. April 2006 um 15 Uhr (nach Verschiebung, ursprünglich geplant für den 10. April 2006 um 16 Uhr) in MB108 statt.}
  \item{Einreichung der Dokumente bis 25. April 2006 (abends) (nach Verschiebung, ursprünglich geplant für den 07. April 2006 (abends)).}
  \end{itemize}
\end{document}