...
public class JavaLexerAdapter extends JavaLexer {
	 ...
	 * 
	 * @param inputState
	 *            The LexerSharedInputState instance to be used.
	 */
	...
	/**
	 * Creates a token of the given type, augmenting it with end position and
	 * file name information based on the shared input state of the instance.
	 * 
	 * @param t
	 *            The token type for the result.
	...
	@Override
	public void newline() {
		((LexerSharedInputStateAdapter) inputState).offset += inputState
				.getColumn() - 1;
		super.newline();
	}

	/**
	 * Increases the number of columns by 1, because we do not need a greater
	 * tabsize.
	 */
	@Override
	public void tab() {
