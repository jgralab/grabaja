...
public class ConstantFactory extends SubgraphFactory {
	 ...
	 * @param integerAST The AST element representing the integer literal.
    ...
    public IntegerConstant createIntegerConstant( AST integerAST ) {
        ...
        IntegerConstant integerConstantVertex = programGraph.createIntegerConstant();
        try{
            integerConstantVertex.setValue( Long.decode( integerConstantAST.getText() ) );
        }
        catch( Exception e ){}
        integerConstantVertex.setLiteral( integerConstantAST.getText() );
        symbolTable.addIntegerConstant( integerConstantAST.getText(), integerConstantVertex );
        return integerConstantVertex;
    }

	/**
	 * Creates a vertex for a char literal.
	 * @param charAST The AST element representing the char literal.
	 * @return The created vertex.
	 */
    public CharConstant createCharConstant( AST charAST ){
        ...
        charConstantVertex.setValue( charConstantAST.getText().charAt( 0 ) );
        charConstantVertex.setLiteral( charConstantAST.getText() );
        symbolTable.addCharConstant( charConstantAST.getText(), charConstantVertex );
        return charConstantVertex;
    }

	/**
	 * Creates a vertex for a String literal.
	 * @param stringAST The AST element representing the String literal.
	 * @return The created vertex.
	 */
    public StringConstant createStringConstant( AST stringAST ){
        ...
        StringConstant stringConstantVertex = programGraph.createStringConstant();
        stringConstantVertex.setValue( stringConstantAST.getText() );
        symbolTable.addStringConstant( stringConstantAST.getText(), stringConstantVertex );
        return stringConstantVertex;
    }

	/**
	 * Creates a vertex for a float literal.
	 * @param floatAST The AST element representing the float literal.
	 * @return The created vertex.
	 */
    public FloatConstant createFloatConstant( AST floatAST ){
        ...
        try{
            floatConstantVertex.setValue( Float.parseFloat( floatConstantAST.getText() ) );
        }
        catch(Exception e){}
        floatConstantVertex.setLiteral( floatConstantAST.getText() );
        symbolTable.addFloatConstant( floatConstantAST.getText(), floatConstantVertex );
        return floatConstantVertex;
    }

	/**
	 * Creates a vertex for a double literal.
	 * @param doubleAST The AST element representing the double literal.
	 * @return The created vertex.
	 */
    public DoubleConstant createDoubleConstant( AST doubleAST ){
        CommonASTAdapter doubleConstantAST = ( CommonASTAdapter )doubleAST;
        if( symbolTable.hasDoubleConstant( doubleConstantAST.getText() ) ) return symbolTable.getDoubleConstant( doubleConstantAST.getText() );
        DoubleConstant doubleConstantVertex = programGraph.createDoubleConstant();
        try{
            doubleConstantVertex.setValue( Double.parseDouble( doubleConstantAST.getText() ) );
        }
        catch(Exception e){}
        doubleConstantVertex.setLiteral( doubleConstantAST.getText() );
        symbolTable.addDoubleConstant( doubleConstantAST.getText(), doubleConstantVertex );
        return doubleConstantVertex;
    }

	/**
	 * Creates a vertex for a long literal.
	 * @param longAST The AST element representing the long literal.
	 * @return The created vertex.
	 */
    public LongConstant createLongConstant( AST longAST ){
        ...
        try{
            if( longConstantAST.getText().toUpperCase().endsWith( "L" ) )
                longConstantVertex.setValue( Long.decode( longConstantAST.getText().substring(0, longConstantAST.getText().length() - 1) ) );
            else
                longConstantVertex.setValue( Long.decode( longConstantAST.getText() ) );
        }
        catch( Exception e ){}
        longConstantVertex.setLiteral( longConstantAST.getText() );
        symbolTable.addLongConstant( longConstantAST.getText(), longConstantVertex );
	...
	public BooleanConstant createBooleanTrueConstant(){
		if( !symbolTable.hasBooleanTrueConstant() ){
			BooleanConstant booleanTrueConstantVertex = programGraph.createBooleanConstant();
            booleanTrueConstantVertex.setValue( true );
	...
	public BooleanConstant createBooleanFalseConstant(){
		if( !symbolTable.hasBooleanFalseConstant() ){
            BooleanConstant booleanFalseConstantVertex = programGraph.createBooleanConstant();
            booleanFalseConstantVertex.setValue( false );
