...
set CLASSPATH=.;jgralab\src\.;common\lib\getopt\java-getopt-1.0.13.jar;common\lib\antlr\org.antlr_2.7.6.jar;%CLASSPATH%
echo ---------------------------------------------------
echo Building JGraLab
javac jgralab\src\de\uni_koblenz\jgralab\*.java
javac jgralab\src\de\uni_koblenz\jgralab\impl\*.java
javac jgralab\src\de\uni_koblenz\jgralab\utilities\tgschema2java\*.java
javac jgralab\src\de\uni_koblenz\jgralab\utilities\tg2dot\*.java
echo ---------------------------------------------------
