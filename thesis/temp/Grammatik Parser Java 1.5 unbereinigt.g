...
(ß)protected typeDefinitionInternal[AST mods]
...
(ß)typeSpec[boolean addImagNode]
...
(ß)classTypeSpec[boolean addImagNode]
...
(ß)classOrInterfaceType[boolean addImagNode]
	:	IDENT (typeArguments)?
		(options{greedy=true;}: // match as many as possible
			DOT^
			IDENT (typeArguments)?
...
// it gobbled.
(ß)protected typeArgumentsOrParametersEnd
	:	GT! {ltCounter-=1;}
	|	SR! {ltCounter-=2;}
	|	BSR! {ltCounter-=3;}
	;
...
(ß)builtInTypeArraySpec[boolean addImagNode]
	:	builtInType
		(options{greedy=true;}: // match as many as possible
			lb:LBRACK^ {#lb.setType(ARRAY_DECLARATOR);} RBRACK!
		)+
...
(ß)builtInTypeSpec[boolean addImagNode]
	:	builtInType
		(options{greedy=true;}: // match as many as possible
			lb:LBRACK^ {#lb.setType(ARRAY_DECLARATOR);} RBRACK!
		)*
...
(ß)annotationMemberValueInitializer
	:
...
(ß)annotationMemberArrayInitializer
...
(ß)annotationMemberArrayValueInitializer
...
(ß)classDefinition![AST modifiers]
	:	"class" IDENT
...
(ß)interfaceDefinition![AST modifiers]
	:	"interface" IDENT
		// it _might_ have type paramaters
		(tp:typeParameters)?
...
(ß)enumDefinition![AST modifiers]
	:	"enum" IDENT
		// it might implement some interfaces...
		ic:implementsClause
...
(ß)annotationDefinition![AST modifiers]
	:	AT "interface" IDENT
...
(ß)explicitConstructorInvocation
	:	(typeArguments)?
...
(ß)variableDefinitions[AST mods, AST t]
 ...
 */
(ß)variableDeclarator![AST mods, AST t]
	:	id:IDENT d:declaratorBrackets[t] v:varInitializer
		{#variableDeclarator = #(#[VARIABLE_DEF,"VARIABLE_DEF"], mods, #(#[TYPE,"TYPE"],d), id, v);}
	;

(ß)declaratorBrackets[AST typ]
...
(ß)variableLengthParameterDeclaration!
...
// logical or (||) (level 11)
(ß)logicalOrExpression
	:	logicalAndExpression (LOR^ logicalAndExpression)*
	;


// logical and (&&) (level 10)
(ß)logicalAndExpression
	:	inclusiveOrExpression (LAND^ inclusiveOrExpression)*
	;


// bitwise or non-short-circuiting or (|) (level 9)
(ß)inclusiveOrExpression
	:	exclusiveOrExpression (BOR^ exclusiveOrExpression)*
	;


// exclusive or (^) (level 8)
(ß)exclusiveOrExpression
...
(ß)equalityExpression
	:	relationalExpression ((NOT_EQUAL^ | EQUAL^) relationalExpression)*
	;


// boolean relational expressions (level 5)
(ß)relationalExpression
	:	shiftExpression
		(	(	(	LT^
				|	GT^
				|	LE^
...
(ß)additiveExpression
	:	multiplicativeExpression ((PLUS^ | MINUS^) multiplicativeExpression)*
	;


// multiplication/division/modulo (level 2)
(ß)multiplicativeExpression
