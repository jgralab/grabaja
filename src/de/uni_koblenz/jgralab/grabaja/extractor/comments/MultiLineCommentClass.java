...
/**
 * Represents a multiple-line comment found by the <code>JavaLexerAdapter</code> in a java-file.
...
public class MultiLineCommentClass extends CommentClass{
     ...
     */
    public MultiLineCommentClass( int offset, int length, int line, int column, Logger logger){
     ...
     * @param unitToAttachTo The <code>TranslationUnit</code>-vertex to attach the <code>MultiLineComment</code>-vertex to.
     */
    public void createTGraphElements( Java5 programGraph, TranslationUnit unitToAttachTo ){
		try{
			MultiLineComment multiLineComment = programGraph.createMultiLineComment();
			IsCommentIn attachingEdge = programGraph.createIsCommentIn( multiLineComment, unitToAttachTo );
