...
import de.uni_koblenz.jgralab.grabaja.java5schema.impl.std.StaticConstructorDefinitionImpl;
...
public class CGStaticConstructorDefinitionImpl extends
	...
	public Vertex generateCode(JavaCodeGenerator jcg, BufferedWriter bw,
		...
		// the block (1,1)
		return ((CGBlockImpl) getFirstIsBodyOfStaticConstructorIncidence(
