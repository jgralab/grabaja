/**
 * Diese Klasse wurde von Eric Blake geschrieben und enthält
 * einige Grenzfälle der Javaspezifikation, ist aber mit javac
 * aus Java 5 kompilierbar.
 * Stammt ursprünglich aus Testquelltexten für die Java 1.5
 * Grammatik von CUP.
 */
