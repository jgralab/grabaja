...
/**
 * Represents a javadoc comment found by the <code>JavaLexerAdapter</code> in a java-file.
...
public class JavaDocCommentClass extends CommentClass{
     ...
     */
    public JavaDocCommentClass( int offset, int length, int line, int column, Logger logger ){
     ...
     * @param unitToAttachTo The <code>TranslationUnit</code>-vertex to attach the <code>JavaDocComment</code>-vertex to.
     */
    public void createTGraphElements( Java5 programGraph, TranslationUnit unitToAttachTo ){
		try{
			...
			IsCommentIn attachingEdge = programGraph.createIsCommentIn( javaDocComment, unitToAttachTo );
